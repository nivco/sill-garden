---
title: Windowsill herbs without a hydro kit
description: Pot-and-soil herbs that work on a real apartment sill — light, watering, and which plants to skip.
pubDate: 2026-08-13
cluster: herbs
type: guide
featured: true
...
products:
  - name: Small herb pots with saucers
    note: Start three herbs without a hydro kit
    search: herb pots with saucers indoor
  - name: Clip-on LED grow light
    note: Cheap fix when the sill isn’t bright enough
    search: LED clip grow light indoor plants
  - name: Genovese basil seeds
    note: The herb that teaches you about light fast
...
|------|------------|-------|
| Basil | Easy in good light | Loves warmth; pinch tops |
| Mint | Easy | Aggressive — keep in its own pot |
| Chives | Easy | Forgiving; cut and come again |
| Parsley | Medium | Slower; keep evenly moist |
...
Buy a countertop hydro system when:

- Your sill never gets strong sun, or
