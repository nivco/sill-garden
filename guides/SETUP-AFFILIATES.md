...
- Store ID / tag: **`sillgarden-20`** in `src/lib/site.ts`
...
3. Confirm tracking ID **`sillgarden-20`** (or create it and update `site.amazonTag`)
4. Test: open any guide CTA → URL must include `tag=sillgarden-20`
...
```
https://www.amazon.com/dp/B07CKNWHPQ?tag=sillgarden-20&linkCode=ll1
https://www.amazon.com/dp/B01MRVMKQH?tag=sillgarden-20&linkCode=ll1
```
